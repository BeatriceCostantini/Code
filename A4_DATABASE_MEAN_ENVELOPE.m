%% DATABASE
folder_path="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\DATABASE_MEAN_ENVELOPE_FINAL"; %This folder DATABASE_FINAL only contains the CSV files created using 
...
writetable(Database, 'DATABASE_MEAN_ENVELOPE_FINAL.csv');
...
fileID=fopen('DATABASE_MEAN_ENVELOPE_FINAL.csv','r');
data=fread(fileID,'*char');
fclose(fileID);
fileID=fopen('DATABASE_MEAN_ENVELOPE_FINAL.csv','w');
fprintf(fileID, '%s\n', strjoin(header, ','));
