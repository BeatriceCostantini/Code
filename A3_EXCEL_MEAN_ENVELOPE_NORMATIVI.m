...
%% NUM_SAMPLES
name_file_excel_NUM_SAMPLES="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\NUM_SAMPLES.xlsx";
...
% ALIFANO M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\ALIFANO M.xlsx";
dati_ALIFANO_M=readtable(filename);

% ALIFANO L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\ALIFANO L.xlsx";
dati_ALIFANO_L=readtable(filename);

% MARINI M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\MARINI M.xlsx";
dati_MARINI_M=readtable(filename);

% MARINI L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\MARINI L.xlsx";
dati_MARINI_L=readtable(filename);

% LOSICCO M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\LOSICCO M.xlsx";
dati_LOSICCO_M=readtable(filename);

% LOSICCO L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\LOSICCO L.xlsx";
dati_LOSICCO_L=readtable(filename);

% ALESSANDRELLI M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\ALESSANDRELLI M.xlsx";
dati_ALESSANDRELLI_M=readtable(filename);

% ALESSANDRELLI L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\ALESSANDRELLI L.xlsx";
dati_ALESSANDRELLI_L=readtable(filename);

% AMER M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\AMER M.xlsx";
dati_AMER_M=readtable(filename);

% AMER L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\AMER L.xlsx";
dati_AMER_L=readtable(filename);

% CARFORA M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\CARFORA M.xlsx";
dati_CARFORA_M=readtable(filename);

% CARFORA L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\CARFORA L.xlsx";
dati_CARFORA_L=readtable(filename);

% RUBBE M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\RUBBE M.xlsx";
dati_RUBBE_M=readtable(filename);

% RUBBE L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\RUBBE L.xlsx";
dati_RUBBE_L=readtable(filename);

% FERRO M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\FERRO M.xlsx";
dati_FERRO_M=readtable(filename);

% FERRO L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\FERRO L.xlsx";
dati_FERRO_L=readtable(filename);

% EL NAGAR M
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\EL NAGAR M.xlsx";
dati_ELNAGAR_M=readtable(filename);

% EL NAGAR L
filename ="C:\Users\b.costantini\Desktop\LAB\DATI\DATI_FINALI\NORMATIVI\EXCEL_NORMATIVI\EL NAGAR L.xlsx";
...
figure
subplot(5,2,1)
generalTitle = 'Low velocity';
sgtitle(generalTitle)
xlim([0 100])
title('EMG Right Rectus Femoris: gait cycle','Color','b')
hold on
plot(new_time_vector,R_RF_mean_envelope_L,'k')
fill([new_time_vector,fliplr(new_time_vector)],...
...
title('EMG Right Vastus Lateralis: gait cycle','Color','b')
hold on
plot(new_time_vector,R_VL_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Right Vastus Medialis: gait cycle','Color','b')
hold on
plot(new_time_vector,R_VM_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Right Biceps femoris caput longus: gait cycle','Color','b')
hold on
plot(new_time_vector,R_BFCL_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Tibialis anterior: gait cycle','Color','b')
hold on
plot(new_time_vector,R_TA_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Peroneus longus: gait cycle','Color','b')
hold on
plot(new_time_vector,R_PL_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Soleus: gait cycle','Color','b')
hold on
plot(new_time_vector,R_SO_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Gastrocnemius latralis: gait cycle','Color','b')
hold on
plot(new_time_vector,R_GL_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
...
title('EMG Gluteus maximus:gait cycle','Color','b')
hold on
plot(new_time_vector,R_GMA_mean_envelope_L,'k')
fill([new_time_vector, fliplr(new_time_vector)],...
