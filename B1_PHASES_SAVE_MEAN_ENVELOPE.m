...
num_NO_ST_VL_1 = sum(strcmp(R_VL_1, 'NO ST'));
percent_ST_VL_1 =[num2str(round(num_ST_VL_1 / (num_ST_VL_1 + num_NO_ST_VL_1) * 100)),'%'];
...
num_NO_ST_VM_1 = sum(strcmp(R_VM_1, 'NO ST'));
percent_ST_VM_1 =[num2str(round(num_ST_VM_1 / (num_ST_VM_1 + num_NO_ST_VM_1) * 100)),'%'];
...
num_NO_ST_G_1 = sum(strcmp(R_G_1, 'NO ST'));
percent_ST_G_1 =[num2str(round(num_ST_G_1 / (num_ST_G_1 + num_NO_ST_G_1) * 100)),'%'];
